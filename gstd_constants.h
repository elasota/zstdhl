...
#define GSTD_MIN_ACCURACY_LOG					5
...
#define GSTD_ACCURACY_BYTE_OFFSET_POS			0
#define GSTD_ACCURACY_BYTE_OFFSET_MASK			3

#define GSTD_ACCURACY_BYTE_MATCH_LENGTH_POS		2
#define GSTD_ACCURACY_BYTE_MATCH_LENGTH_MASK	7
